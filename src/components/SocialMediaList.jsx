...
function SocialMediaList() {
  return (
    <footer title="Footer Section" className="my-7 mx-auto p-0 w-[85%]">
      <ul
        className="list-none justify-center flex-wrap grid grid-rows-1 grid-flow-col 
        gap-x-8 gap-y-2 max-sm:grid-rows-2 max-sm:grid-flow-col max-sm:gap-x-8 max-sm:gap-y-2"
      >
        <SocialMediaItem
